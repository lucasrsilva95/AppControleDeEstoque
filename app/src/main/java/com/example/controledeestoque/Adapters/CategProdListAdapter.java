...
public class CategProdListAdapter extends RecyclerView.Adapter<CategProdListAdapter.ViewHolderProduto> {
    ...
    public CategProdListAdapter(List<String> categAbertas, Context context) {
